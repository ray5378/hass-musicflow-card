        ...
        <div class="browser" @click=${a=>a.stopPropagation()}>
          ...
          <div class="br-crumbs">
            ${e.map((a,o)=>u`
              ...
              ${o<e.length-1?u`<span class="crumb-sep">›</span>`:""}
            `)}
          </div>
          ${r?u`
            <div class="br-search">
